...
***
***Параметры.***
1. `-a (--archive)` - скопировать файлы и каталоги со всеми [[Атрибуты файла|атрибутами]], включая [[Идентификация|идентификаторы]] и [[Права доступа к файлу|права доступа]].
