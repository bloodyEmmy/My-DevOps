#flashcards/os/Unix 
***
Позволяет прокручивать текстовый файл взад и вперед => вывод содержимого файла. 
- Если файл занимает больше одной страницы, то его можно прокручивать вверх и вниз.
***
***Команды***:
