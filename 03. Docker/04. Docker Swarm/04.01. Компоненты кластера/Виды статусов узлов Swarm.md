#flashcards/Docker
***
1. ***STATUS*** - доступность [[Узел в Swarm (Нода, Node)|узла]] в [[Кластер|кластере]].
...
3. ***MANAGER STATUS*** - роль узла в [[Raft Consensus]]. Только для [[Управляющий узел (manager node) в Swarm|менеджеров]].
