#flashcards/Docker
***
Отдельная база данных, ***НЕ ВСТРОЕННАЯ В [[Docker Engine]]***, расположенная на всех управляющих [[Узел в Swarm (Нода, Node)]] внутри [[Кластер]], в которой хранятся все метаданные о кластере (какие узлы есть, какие [[Сервис в Swarm]] запущены, какие ресурсы доступны и др.).
